...
<AccordionGroup>
  ...
  <Accordion title="Como validar que um webhook veio da AbacatePay?">
    Cada requisição inclui o header `X-Webhook-Signature` com uma assinatura HMAC-SHA256. Consulte a [página de webhooks](/pages/webhooks) para o exemplo de validação completo.
  </Accordion>
</AccordionGroup>

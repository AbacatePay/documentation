...
<Card title="Comportamento da regra" icon="info"> A regra <strong>não aplica autofix destrutivo</strong>. Sempre que possível, ela oferece <strong>sugestões seguras</strong> para substituição. </Card>

...
<CardGroup cols={2}> <Card title="REST Client (Go)" icon="repeat"> Cliente HTTP oficial em Go que consome esses contratos diretamente. </Card> <Card title="SDKs & Ferramentas" icon="boxes-stacked"> SDKs, CLIs e ferramentas que reutilizam os mesmos tipos versionados. </Card> </CardGroup>

### Open Source, de Verdade

<Card title="Feito para Go" icon="heart"> O <code>abacatepay/go-types</code> é open source e mantido pela equipe AbacatePay. Structs estáveis, versionadas e 100% alinhadas à documentação oficial da API. </Card>

...
<Card title="Por que usar o Dev mode?" icon="star" horizontal>
...
## <Icon icon="key" type="solid"/> Como usar o Dev mode
...
<Card title="Boas práticas ao testar" icon="lightbulb" horizontal>

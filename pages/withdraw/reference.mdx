...
O módulo de **payouts** permite que você transfira valores da sua conta AbacatePay para uma chave PIX de sua escolha. É uma funcionalidade essencial para gerenciar seus fundos e realizar transferências.

Atualmente, o payouts suporta apenas o método **PIX**, que é o método mais rápido e eficiente para transferências no Brasil.
...
<AccordionGroup>
    ...
    <Accordion title="BR_CODE:">
        Copia & cola de recebimento gerado pelo beneficiário.
        
        **Exemplo:** `00020101021111580014br.gov.bcb.pix08667123e4f0-a25t-4603-axd0-3f8831da7da75204000053039865801BR5921Abacate6016ABACATELANDIA61070553***6304BB33
`
    </Accordion>
</AccordionGroup>

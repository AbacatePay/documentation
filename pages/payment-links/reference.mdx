...
Use **GET /payment-links/get** (por ID) e **GET /payment-links/list** para buscar e listar. O `GET /checkouts/list` lista só checkouts de pagamento único e não traz links de pagamento.

...
<Warning>
  Cobranças de assinatura (checkout `bill_...` ou pagamento de uma assinatura) não podem ser reembolsadas pela API v2. A API retorna `Cobranças de assinatura não podem ser reembolsadas pela API v2.`
</Warning>

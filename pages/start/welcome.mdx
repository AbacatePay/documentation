...
<div style={{ 
  ...
  <div style={{ 
    ...
    <Card icon="qrcode" title="Receber via Pix" href="/pages/pix-qrcode/create">
  ...
  <div style={{ textAlign: "center", marginTop: "32px" }}>
    <button
      id="load-more-btn"
      onClick={() => {
        const cards = ['card-11', 'card-15', 'card-16', 'card-17', 'card-18', 'card-19'];
  ...
  <div id="card-11" style={{ display: "none", marginTop: "32px" }}>
    <div style={{ 
      ...
      <Card icon="route" title="HTTP" href="/pages/http">
        Crie requisições HTTP facilmente com as nossas collections e arquivos HTTP.
      </Card>

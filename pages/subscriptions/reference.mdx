...
**Assinatura** é um Checkout para cobrança recorrente: mesma página de pagamento do [Checkout](/pages/payment/reference), mesmos parâmetros. A diferença é que aceita **só um produto**, e esse produto precisa ter **ciclo (frequency)** definido na loja.

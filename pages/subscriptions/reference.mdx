...
| Recurso | ID | Quando existe | Buscar | Listar |
|---------|----|---------------|--------|--------|
| Checkout de assinatura | `bill_...` | Desde o `POST /subscriptions/create` | [`GET /subscriptions/checkouts/get`](/pages/subscriptions/checkouts-get) | [`GET /subscriptions/checkouts/list`](/pages/subscriptions/checkouts-list) |
| Assinatura | `subs_...` | Depois do pagamento do checkout | [`GET /subscriptions/get`](/pages/subscriptions/get) | [`GET /subscriptions/list`](/pages/subscriptions/list) |
...
<Warning>
  Checkouts de assinatura não saem mais pelo `GET /checkouts/get` nem pelo `GET /payment-links/get` desde 23/09/2026. Veja o [changelog](/pages/changelog/index).
</Warning>

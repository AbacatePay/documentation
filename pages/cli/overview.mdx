...
Projetada para **desenvolvedores** e **infra**, permite criar cobranças, escutar webhooks, simular pagamentos e automatizar fluxos — tudo sem sair do terminal.
...
<Tip>
Use `-h` em qualquer comando para ver a ajuda detalhada: `abacatepay payments -h`
</Tip>

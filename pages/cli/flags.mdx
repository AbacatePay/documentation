...
<Warning>
A flag `--local` (`-l`) conecta ao servidor de teste. **Nunca use dados reais** neste modo.
</Warning>
...
<CardGroup cols={2}>
  <Card title="← Visão Geral" icon="arrow-left" href="./overview">
    Introdução e início rápido da CLI.
  </Card>
  <Card title="Autenticação →" icon="key" href="./auth">
    Comandos de login, logout e perfis.
  </Card>
</CardGroup>
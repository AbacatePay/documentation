...
<CardGroup cols={2}> <Card title="SDK Oficial" icon="box" href="https://www.npmjs.com/package/@abacatepay/sdk"> Wrapper de alto nível para produção. </Card> <Card title="Documentação" icon="book" href="https://docs.abacatepay.com/pages/http"> Referência completa da API. </Card> </CardGroup> <Card title="Open source de verdade" icon="heart"> Mantido pela equipe AbacatePay e pela comunidade. Simples, transparente e sem mágica. </Card>

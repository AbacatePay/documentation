...
Você pode exibir um produto adicional na tela de pagamento usando o campo `upSellProductId`. O produto é apresentado ao cliente como um complemento opcional antes de ele finalizar o pagamento — ideal para aumentar o ticket médio sem criar um checkout separado.

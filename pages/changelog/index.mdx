...
- As respostas do get de checkouts, links de pagamento e assinaturas ficavam em cache por até 1 hora, então o `status` podia aparecer desatualizado logo depois de um pagamento ou cancelamento. O cache agora dura 60 segundos, igual ao das listagens
